...
- [MindSearch](https://github.com/InternLM/MindSearch) - frontend-only live semantic search with transformers.js. - ![GitHub Repo stars](https://img.shields.io/github/stars/InternLM/MindSearch?style=social)
